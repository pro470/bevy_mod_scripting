...
impl ::core::time::Duration {
    ...
    fn add(
        ...
        let output: Val<::core::time::Duration> = <::core::time::Duration as std::ops::Add<
            ::core::time::Duration,
    ...
    fn assert_receiver_is_total_eq(_self: Ref<::core::time::Duration>) -> () {
        let output: () = <::core::time::Duration as std::cmp::Eq>::assert_receiver_is_total_eq(
                &_self,
            )
            .into();
        output
    ...
    fn div(_self: Val<::core::time::Duration>, rhs: u32) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> = <::core::time::Duration as std::ops::Div<
            u32,
    ...
    fn eq(_self: Ref<::core::time::Duration>, other: Ref<::core::time::Duration>) -> bool {
        let output: bool = <::core::time::Duration as std::cmp::PartialEq<
            ::core::time::Duration,
        >>::eq(&_self, &other)
            .into();
        output
    ...
    fn mul(_self: Val<::core::time::Duration>, rhs: u32) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> = <::core::time::Duration as std::ops::Mul<
            u32,
    ...
    fn sub(
        ...
        let output: Val<::core::time::Duration> = <::core::time::Duration as std::ops::Sub<
            ::core::time::Duration,
...
impl bevy::platform::time::Instant {
    ...
    fn duration_since(
        ...
        let output: Val<::core::time::Duration> = bevy::platform::time::Instant::duration_since(
                &_self,
                earlier.into_inner(),
            )
            .into();
    ...
    ///  ```
    fn elapsed(_self: Ref<bevy::platform::time::Instant>) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> = bevy::platform::time::Instant::elapsed(&_self)
            .into();
        output
    }
    ...
    fn saturating_duration_since(
        ...
        let output: Val<::core::time::Duration> = bevy::platform::time::Instant::saturating_duration_since(
                &_self,
                earlier.into_inner(),
            )
            .into();
    ...
    fn sub(
        ...
        let output: Val<::core::time::Duration> = <bevy::platform::time::Instant as std::ops::Sub<
            bevy::platform::time::Instant,
        >>::sub(_self.into_inner(), other.into_inner())
            .into();
        output
